...
namespace project13Sept.Data
{
    /// <summary>
    /// Represents the database context for the application.
    /// </summary>
    public class project13SeptContext : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-GFUVFUP;Initial Catalog=T238325_project13Sept;Persist Security Info=True;user id=pankazz;password=123456;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
