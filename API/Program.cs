...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "project13Sept", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<project13SeptContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "project13Sept API v1");
